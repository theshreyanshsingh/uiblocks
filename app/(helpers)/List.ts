import glow from "../(helpers)/list_assets/glow.png";
import glass from "../(helpers)/list_assets/glass.png";
import gradient from "../(helpers)/list_assets/gradient.png";
import movingline from "../(helpers)/list_assets/movingline.png";
import simplebutton from "../(helpers)/list_assets/simplebutton.png";
import popup from "../(helpers)/list_assets/popup.png";
import hovernav from "../(helpers)/list_assets/hovernav.png";
import typewriter from "../(helpers)/list_assets/typewriter.png";
import imagereveal from "../(helpers)/list_assets/imagereveal.png";
import card from "../(helpers)/list_assets/card.png";
import chat from "../(helpers)/list_assets/chat.png";
import tooltip from "../(helpers)/list_assets/tooltip.png";
import dropdown from "../(helpers)/list_assets/dropdown.png";
import globe from "../(helpers)/list_assets/globe.png";
import datetime from "../(helpers)/list_assets/datetime.png";
import toast from "../(helpers)/list_assets/toast.png";
import table from "../(helpers)/list_assets/table.png";
import loading from "../(helpers)/list_assets/loading.png";
import animate from "../(helpers)/list_assets/animate.png";
import toggle from "../(helpers)/list_assets/toggle.png";
import waves from "../(helpers)/list_assets/waves.png";
import switcher from "../(helpers)/list_assets/switcher.png";
import particle from "../(helpers)/list_assets/particle.png";
import hovergradient from "../(helpers)/list_assets/hovergradient.png";
import fallingbeam from "../(helpers)/list_assets/fallingbeam.png";
import scroll from "../(helpers)/list_assets/scroll.png";
import kanban from "../(helpers)/list_assets/kanban.png";
import fileupload from "../(helpers)/list_assets/fileupload.png";
import hearts from "../(helpers)/list_assets/hearts.png";
import hovercard from "../(helpers)/list_assets/hovercard.png";
import social from "../(helpers)/list_assets/social.png";
import animatesocial from "../(helpers)/list_assets/animatesocial.png";
import htestimonial from "../(helpers)/list_assets/htestimonial.png";
import vtestimonial from "../(helpers)/list_assets/vtestimonial.png";
import ntestimonial from "../(helpers)/list_assets/ntestimonial.png";
import button from "../(helpers)/list_assets/button.png";
import alert from "../(helpers)/list_assets/alert.png";
import checkbox from "../(helpers)/list_assets/checkbox.png";
import likedislike from "../(helpers)/list_assets/likedislike.png";
import drawer from "../(helpers)/list_assets/drawer.png";
import follow from "../(helpers)/list_assets/follow.png";
import hoverzoom from "../(helpers)/list_assets/hoverzoom.png";
import radio from "../(helpers)/list_assets/radio.png";
import status from "../(helpers)/list_assets/status.png";
import stepper from "../(helpers)/list_assets/stepper.png";
import textarea from "../(helpers)/list_assets/textarea.png";
import gradientimage from "../(helpers)/list_assets/gardientimage.png";
import scaleimage from "../(helpers)/list_assets/scaleimage.png";
...
import MainDragdrop from "../(pages)/components/[component]/_listOfComponents/Kanban";
...
import HoverCard from '@/app/component/HoverCard';
  ...
  {
    name: "Kanban Board",
    desc: "A cool kanban board with drag and drop support",
    premium: false,
    component: MainDragdrop,
    codeSnippets: [
      {
        title: "Usage",
        code: `
